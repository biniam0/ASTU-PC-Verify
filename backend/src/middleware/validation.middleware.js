...
export const studentValidations = {
  register: [
    ...
    body("yearOfEntry")
      .notEmpty()
      .withMessage("Year of entry is required")
      .isInt({ min: 2000, max: new Date().getFullYear() + 1 })
      .withMessage(
        `Year of entry must be between 2000 and ${new Date().getFullYear() + 1}`,
      ),
...
export const laptopValidations = {
  register: [
    ...
    body("serialNumber")
      ...
      .withMessage("Serial number must be between 5 and 100 characters")
      .matches(/^[a-zA-Z0-9-]+$/)
      .withMessage(
    ...
    body("macAddress")
      ...
      .withMessage("Invalid MAC address format (e.g., 00:1A:2B:3C:4D:5E)"),

    body("purchaseYear")
      .optional()
      .isInt({ min: 1990, max: new Date().getFullYear() })
      .withMessage(
        `Purchase year must be between 1990 and ${new Date().getFullYear()}`,
      )
      .toInt(),
  ],
  ...
  update: [
    param("laptopId")
      ...
      .isUUID()
      .withMessage("Invalid laptop ID format"),
...
export const authValidations = {
  register: [
    ...
    body("role")
      ...
      .isIn(["admin", "security"])
      .withMessage("Role must be admin or security"),
...
export const verificationValidations = {
  scan: [
    ...
    body("scannerType")
      ...
      .withMessage(
        "Scanner type must be barcode, qr, rfid, manual, or unknown",
      ),

    body("gateLocation")
      .optional()
      .isLength({ max: 100 })
      .withMessage("Gate location too long"),
  ],
...
export const settingsValidations = {
  ...
  gate: {
    create: [
      ...
      body("scannerType")
        .notEmpty()
        .withMessage("Scanner type is required")
        .isIn(["barcode", "qr", "rfid", "manual"])
        .withMessage("Invalid scanner type"),
