...
const navItems = [
  { to: '/register-student', label: 'Register student', icon: PersonIcon, roles: ['admin'] },
  { to: '/register-laptop', label: 'Register Laptop', icon: LaptopIcon, roles: ['admin'] },
  { to: '/manage-students', label: 'Manage Students', icon: PeopleIcon, roles: ['admin'] },
  { to: '/manage-laptops', label: 'Manage laptops', icon: MonitorIcon, roles: ['admin'] },
  { to: '/security-verification', label: 'Security Verification', icon: ShieldLockIcon, roles: ['admin', 'security'] },
] as const
...
function LaptopIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <SvgPath strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
    </svg>
  )
}
function PeopleIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <SvgPath strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
    </svg>
  )
}
