...
export function RegisterLaptopPage() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    e.preventDefault()
    setError(null)
    const { studentId, brandName, model, serialNumber, macAddress, frontView, backView, serialNumberImage, macAddressScreen } = form
    ...
    try {
      ...
      if (frontView) uploads.push(uploadLaptopImage(laptop.id, 'front', frontView))
      if (backView) uploads.push(uploadLaptopImage(laptop.id, 'back', backView))
      if (serialNumberImage) uploads.push(uploadLaptopImage(laptop.id, 'serial', serialNumberImage))
      if (macAddressScreen) uploads.push(uploadLaptopImage(laptop.id, 'mac', macAddressScreen))
