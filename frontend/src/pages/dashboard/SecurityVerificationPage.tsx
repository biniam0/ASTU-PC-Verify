...
export function SecurityVerificationPage() {
  ...
  const verifyWithId = useCallback(async (id: string) => {
    ...
    if (!STUDENT_ID_REGEX.test(trimmed)) {
      setScanError('Student ID must be in the format Ugr/12345/16, MSc/12345/16, or PhD/12345/16.')
      return
    }
    setScanning(true)
    try {
                ...
                <div className="space-y-2">
                  ...
                  <dl className="grid gap-1 text-sm sm:grid-cols-2">
                    ...
                    {result.laptop?.imageUrl && (
                      <div className="mt-3">
                        <p className="text-sm font-medium text-gray-700">Registered laptop image</p>
