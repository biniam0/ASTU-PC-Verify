...
export interface Laptop extends Omit<
  RegisterLaptopPayload,
  "frontView" | "backView" | "serialNumberImage" | "macAddressScreen"
> {
  id: string;
  /** Display id for list (e.g. LPT/001) */
  laptopId?: string;
  /** Numeric student database id (foreign key from laptops.student_id) */
  studentDbId?: string;
